        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: PageView(
                  ...
                  children: [
                    SizedBox(
                      child: Image.asset(
                        'src/assets/model20${widget.id}.png',
                        // Use id for dynamic image
                      ),
                    ),
                    SizedBox(
                      child: Image.asset(
                        'src/assets/model10${widget.id}.png',
                      ),
                    ),
                    SizedBox(
                      child: Image.asset(
              ...
              Text(
                'The Nike GTX $widget.id Shoe borrows design lines from the heritage runners like the Nike React Technology.',
                style: const TextStyle(
                  height: 1.6,
                  fontWeight: FontWeight.bold,
                  fontSize: 14,
