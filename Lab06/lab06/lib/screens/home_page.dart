...
import 'package:lab06/screens/alarm_screen.dart';
import 'package:lab06/screens/wifi_battery_screen.dart';
...
class _HomePageState extends State<HomePage> {
  showDetailScreen(int productId, String productName, String productPrice) {
    Navigator.push(
        context, MaterialPageRoute(builder: (_) => DetailsPage(id: productId, productName: productName, price: productPrice)));
  }
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            IconButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) => const WifiBatteryInfoScreen()));
              },
              icon: const Icon(
                Icons.menu,
                color: Colors.black,
              ...
              child: Row(
                children: [
                  for (int i = 0; i <= 2; i++)
                    InkWell(
                      onTap: () {
                        showDetailScreen(i + 1, 'Nike GTX ${i + 1}',
                            i == 0
                            ? '329'
                            : i == 1
                            ? '100'
